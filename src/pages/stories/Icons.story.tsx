...
const ICONS = [
  ...
  'apple', 'apple-watch', 'arrow-down', 'arrow-down-left', 'arrow-down-right', 'arrow-left',
  ...
  'eye-off', 'face-id', 'facebook', 'facebook-filled', 'faq', 'faq-filled', 'film', 'filter', 'finger-print', 'flag',
  ...
  'gift', 'gift-filled', 'google', 'hand-up', 'heart', 'heart-filled', 'hexagon-circle', 'home',
  'home-filled', 'home-user', 'home-user-filled', 'info', 'info-filled', 'instagram',
  'invoice', 'invoice-filled', 'invoice-money', 'invoice-money-filled', 'invoice-text',
  'invos-heart', 'key', 'keyboard', 'line', 'linkedin', 'list', 'list-check', 'list-pen', 'list-plus', 'list-point', 'lock',
  'lock-off', 'logo-invos', 'loud-speaker', 'loud-speaker-filled', 'magnifier', 'mail',
  'map', 'map-pin', 'medium', 'member-card', 'meta', 'microphone', 'microphone-off',
  'minus', 'minus-circle', 'minus-circle-filled', 'mobile', 'mobile-add', 'mobile-barcode',
  'mobile-vibration', 'mobile-vibration-off', 'moon',
  ...
  'tag', 'tag-cross', 'target', 'threads', 'three-dots', 'three-line', 'thumb-down',
  'thumb-down-filled', 'thumb-up', 'thumb-up-filled', 'thunder', 'thunder-filled',
  'thunder-filled-off', 'ticket', 'translation', 'trash-can', 'trophy', 'twinkle',
  'twitter-x', 'user', 'user-box', 'user-cog', 'user-group', 'video', 'volume-off',
  'volume-on', 'volumn-filled-off', 'volumn-filled-on', 'wallet', 'wallet-ios', 'youtube',
]
